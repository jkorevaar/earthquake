...
```{r, message=FALSE}
filename <- system.file("extdata", "earthquakes-2020-10-19_15-21-05_+0300.tsv", package = "earthquak")
...
```{r, message=FALSE}
library(dplyr)
clean_earthquakes <- eq_clean_data(earthquakes)
```
